...
> 最終更新: 2026-03-01（Phase F-2 入門英文問題精講 構造化開始）
...
| **F** | 他参考書の独立構造化＋参考書間リンク | **進行中** | F-1: 肘井完了（49ノード・405英文）。F-2: 入門英文問題精講 進行中 |
| **G** | 生徒習熟度管理・SM-2 | 未着手 | |
...
#### F-2: 入門英文問題精講（進行中）
- **対象**: 入門英文問題精講〔4訂版〕（竹岡広信・旺文社）
- **セクション数**: 85（基本講義13 + 演習72問）
- **想定ノード数**: 50〜65（基本講義13 + 演習40〜55）
- **7カテゴリ**: 基本講義(nbk) / 主語と動詞の把握(nsv) / 準動詞(njd) / 関係詞(nks) / 接続詞(nst) / 比較(nhk) / その他(nta)
- **Phase 1（パイロット）完了**: Ny_G01, Ny_01, Ny_20（3セクション・3ノード・4英文）
- **Phase 2（本格構造化）**: 進行中
- データ: `scripts/supabase/nyumon_data/`
